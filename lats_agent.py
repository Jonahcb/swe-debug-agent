...
# Test configuration
TEST_COMMAND = "CUDA_VISIBLE_DEVICES=2 /raid/home/chenyang/miniconda3/envs/lats -m unittest -vv test_lora_hf_sgl_logprob_diff.TestLoRAHFSGLLogprobDifference.test_moe_lora_logprob_comparison_full"
